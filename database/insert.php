...
if($index >= 12 || $index < 10000)
{    //exit();
$sql    = 'SELECT `id`,`institute`,`ville`, `province`,`country` FROM `address_unique` where `latlongid`  is NULL  and `Country` = "United States" or `Country` = "Canada" Limit '.($index*1).", 8 ";
}else{
    exit();
}
